...
class main:
    ...
    def parseUrl(self):
        ...
        if (oInputParameterHandler.exist('site')):
            ...
            if (isDlm3u8(sSiteName, sFunction) == True):
                return
...
def isDlm3u8(sSiteName, sFunction):
    if (sSiteName == 'cDlm3u8'):
        from resources.lib.dlm3u8 import cDlm3u8
        oDlm3u8 = cDlm3u8()
        exec "oDlm3u8."+ sFunction +"()"
        return True
    return False
